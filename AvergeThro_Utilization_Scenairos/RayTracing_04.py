...
def main():
    # File path
    file_path = r"C:\Users\Jingwen TONG\Desktop\我的文档\02_项目_202301\16-WirelessAgent-ChinaCom\Simulations\WirelessAgent_V1\Knowledge_Base\HKUST_South.osm"
    ...
    try:
        ...
        # Save results to CSV=============================================================================================================
        output_path = 'ray_tracing_results_south.csv' # Output file path modifed by Jingwen TONG
        ...
        plt.savefig('ray_tracing_map_south.png', dpi=300)  #changed by Jingwen
        plt.show()
        ...
        plt.axis('equal')
        plt.grid(True, linestyle='--', alpha=0.7)
        plt.savefig('cqi_distribution_south.png', dpi=300)
