...
# 2025-11-27 10:36 Old version entance, file for network slicing package 
...
# Set up LLM
llm = ChatOpenAI(
    api_key="sk-4aee6405765f41f2b808a29dedbd983b",
...
if __name__ == "__main__":
    ...
    main(num_users=3, export_file="network_slicing_results_DSv3KB.csv")